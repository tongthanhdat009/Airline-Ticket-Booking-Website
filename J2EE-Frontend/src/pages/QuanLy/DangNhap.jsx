...
function DangNhapAdmin() {
 ...
 return (
 <div className="min-h-screen bg-linear-to-br from-sky-400 via-blue-500 to-indigo-600 flex items-center justify-center p-4">
 ...
 type="submit"
 disabled={loading}
 className="w-full bg-linear-to-r from-sky-500 to-blue-600 hover:bg-sky-600 text-white font-semibold py-3 px-6 rounded-lg shadow-lg hover:shadow-xl transform hover:scale-[1.02] active:scale-[0.98] transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
 >
 {loading ? (
