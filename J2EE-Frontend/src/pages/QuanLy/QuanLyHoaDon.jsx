...
const QuanLyHoaDon = () => {
 ...
 <button
 onClick={() => loadData()}
 className="flex items-center gap-2 bg-blue-500 text-white px-5 py-3 rounded-lg hover:bg-blue-600 transition-all shadow-lg hover:shadow-xl font-semibold"
 >
 <FaCalendar />
