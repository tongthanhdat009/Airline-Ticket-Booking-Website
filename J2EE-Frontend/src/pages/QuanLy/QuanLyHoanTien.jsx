...
const QuanLyHoanTien = () => {
 ...
 onClick={loadData}
 disabled={loading}
 className="flex items-center gap-2 bg-amber-500 text-white px-5 py-3 rounded-lg hover:bg-amber-600 transition-all shadow-lg hover:shadow-xl font-semibold disabled:opacity-50 disabled:cursor-not-allowed"
 >
 <FaCalendar />
