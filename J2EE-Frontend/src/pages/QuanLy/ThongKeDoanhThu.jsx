...
"Doanh thu": parseFloat(item.tongDoanhThu)
 ...
 <div className="bg-white border border-gray-200/60 p-4 sm:p-6 rounded-xl sm:rounded-2xl shadow-sm">
 <div className="flex items-center justify-between mb-3 sm:mb-4">
 <div>
 <h3 className="text-lg sm:text-xl font-bold text-gray-800 flex items-center gap-2">
 <div className="p-2 bg-blue-50 rounded-lg">
 <FaCalendarDay className="text-lg sm:text-xl text-blue-600" />
 </div>
 Thống kê hôm nay
 </h3>
 ...
 className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-3 sm:px-4 py-2 sm:py-2.5 bg-red-500 text-white rounded-lg hover:bg-red-600 transition-all shadow-md font-medium text-sm"
 >
 ...
 <button onClick={fetchAllStatistics} className="px-3 sm:px-4 py-2 bg-blue-600 text-white rounded-lg text-xs sm:text-sm hover:bg-blue-700 transition-colors">
 Thử lại
 </button>
 </div>
 </div>
