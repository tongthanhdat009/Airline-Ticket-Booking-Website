...
const QuanLyDonHang = () => {
 ...
 <p className="text-2xl font-bold mt-1.5 text-gray-800">{donHangList.length}</p>
 </div>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Đã thanh toán</p>
 ...
 <div className="flex items-center justify-between">
 <div>
 <p className="text-xs font-medium text-gray-500 uppercase tracking-wide">Chờ thanh toán</p>
 <p className="text-2xl font-bold mt-1.5 text-gray-800">
 {donHangList.filter((dh) => dh.trangThai === 'CHỜ THANH TOÁN').length}
 </p>
 </div>
 <div className="p-3 bg-amber-50 rounded-lg">
 <FaCalendar size={22} className="text-amber-500" />
 </div>
 </div>
 </div>
 ...
 <FaShoppingCart size={22} className="text-indigo-500" />
 </div>
 </div>
 </div>
 </div>
 ...
 {/* Thanh phân trang */}
 {!loading && !error && filteredDonHang.length > 0 && (
 ...
 <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6 flex flex-col sm:flex-row justify-between items-center gap-3">
 ...
 className="flex items-center gap-2 bg-orange-500 text-white px-4 py-2 rounded-lg hover:bg-orange-600 font-semibold transition-all shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
 >
 <FaUndo />
