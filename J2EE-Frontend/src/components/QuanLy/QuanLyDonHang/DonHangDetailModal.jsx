...
const DonHangDetailModal = ({
 ...
 className="px-4 md:px-6 py-2 md:py-3 [background:linear-gradient(to_right,rgb(239,68,68),rgb(225,29,72))] text-white rounded-lg hover:bg-red-600 font-semibold transition-all shadow-lg flex items-center gap-2 disabled:opacity-50 text-sm md:text-base"
 >
 <FaTimesCircle />
 Hủy đơn hàng
 </button>
 ...
 disabled={actionLoading}
 className="px-4 md:px-6 py-2 md:py-3 [background:linear-gradient(to_right,rgb(249,115,22),rgb(217,119,6))] text-white rounded-lg hover:bg-orange-600 font-semibold transition-all shadow-lg flex items-center gap-2 disabled:opacity-50 text-sm md:text-base"
 >
 <FaUndo />
 Hoàn tiền
 </button>
