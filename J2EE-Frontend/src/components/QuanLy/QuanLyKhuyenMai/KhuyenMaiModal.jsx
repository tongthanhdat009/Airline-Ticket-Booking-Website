...
const KhuyenMaiModal = ({ isOpen, onClose, onSave, promotion, showToast }) => {
 ...
 <div className="bg-pink-600 text-white p-6 rounded-t-xl sticky top-0">
 ...
 type="submit"
 disabled={isSubmitting}
 className="px-6 py-3 bg-pink-500 text-white rounded-lg hover:bg-pink-600 font-semibold transition-all shadow-lg disabled:opacity-50"
 >
