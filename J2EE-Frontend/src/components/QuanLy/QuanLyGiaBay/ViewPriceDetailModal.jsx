...
const ViewPriceDetailModal = ({ 
 ...
 <div className="sticky top-0 bg-blue-600 text-white px-6 py-4 flex justify-between items-center z-10">
 ...
 <button 
 onClick={onAddNew}
 className="flex items-center gap-2 bg-green-500 text-white px-4 py-2 rounded-lg hover:bg-green-600 transition-all shadow-md hover:shadow-lg text-sm font-semibold"
 >
 <FaPlus size={14} />
 <span>Thêm giá</span>
 </button>
