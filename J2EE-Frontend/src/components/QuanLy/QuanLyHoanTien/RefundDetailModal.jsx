...
const RefundDetailModal = ({
 ...
 {/* Header */}
 <div className="bg-amber-600 text-white p-6 rounded-t-xl sticky top-0">
 ...
 disabled={actionLoading}
 className="px-6 py-3 bg-green-500 text-white rounded-lg hover:bg-green-600 font-semibold transition-all shadow-lg flex items-center gap-2 disabled:opacity-50"
 >
 <FaCheck />
 Duyệt hoàn tiền
 </button>
