...
const DoiHangVeModal = ({
 ...
 {/* Header */}
 <div className="bg-violet-600 px-6 py-4 rounded-t-2xl">
 ...
 className="flex-1 px-4 py-2 bg-violet-600 text-white rounded-lg hover:bg-violet-700 font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
 >
 {loading ? (
 <>
