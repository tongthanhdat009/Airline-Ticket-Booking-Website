...
const HuyVeModal = ({ isOpen, onClose, onConfirm, datCho, loading }) => {
 ...
 {/* Header */}
 <div className="rounded-t-xl bg-red-500 px-6 py-4">
 ...
 className="flex flex-1 items-center justify-center gap-2 rounded-lg bg-red-500 px-4 py-2.5 text-sm font-medium text-white transition-all hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
 >
 {loading ? (
 <>
