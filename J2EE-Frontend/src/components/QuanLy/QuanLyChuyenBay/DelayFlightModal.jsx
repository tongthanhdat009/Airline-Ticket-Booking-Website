...
const DelayFlightModal = ({ isOpen, onClose, onSubmit, delayData, onDelayDataChange }) => {
 ...
 <div className="sticky top-0 bg-red-600 text-white p-6 rounded-t-xl">
 ...
 <button
 type="submit"
 className="px-6 py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 font-semibold transition-all shadow-lg"
 >
 Cập nhật Delay
 </button>
 </div>
