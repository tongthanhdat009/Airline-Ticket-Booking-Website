...
const CancelFlightModal = ({ isOpen, onClose, onSubmit, cancelData, onCancelDataChange }) => {
 ...
 {/* Header */}
 <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-red-500 rounded-t-2xl">
 ...
 <button
 type="submit"
 className="flex-1 px-4 py-3 bg-red-500 text-white rounded-lg hover:bg-red-600 font-semibold shadow-lg hover:shadow-xl transition-all"
 >
 Xác nhận hủy
 </button>
 </div>
