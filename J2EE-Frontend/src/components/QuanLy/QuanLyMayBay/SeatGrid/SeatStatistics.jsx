...
const SeatStatistics = ({ seats, hangVeList, sidebarCollapsed, setSidebarCollapsed }) => {
 ...
 className="fixed right-0 top-1/2 -translate-y-1/2 bg-linear-to-l from-blue-600 to-indigo-600 text-white p-3 rounded-l-xl shadow-lg z-30 hover:bg-blue-700 transition-all group"
