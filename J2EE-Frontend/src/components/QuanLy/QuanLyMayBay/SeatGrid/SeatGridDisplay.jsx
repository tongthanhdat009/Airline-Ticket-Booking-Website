...
const SeatGridDisplay = ({
 ...
 {/* Clean tooltip */}
 <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-blue-700 text-white text-xs px-3 py-1.5 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-200 pointer-events-none whitespace-nowrap z-30 shadow-lg">
