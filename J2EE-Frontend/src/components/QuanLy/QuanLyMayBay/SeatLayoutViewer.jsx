...
const SeatLayoutViewer = ({ maMayBay, onClose }) => {
 ...
 <div className="bg-sky-50 px-6 py-4 border-b-2 border-sky-200">
 ...
 <div className="w-16 h-3 from-blue-400 via-green-400 to-blue-400 rounded"></div>
 </div>
 <div className="text-center">
...
const SeatGrid = ({ seats, getSeatStyle, onSeatHover, onSeatLeave }) => {
 ...
 {/* Body */}
 <div className="h-6 from-sky-400 via-sky-500 to-sky-400 rounded-t-full w-64 shadow-md"></div>
 </div>
 </div>
 ...
 <div className="h-6 from-sky-400 via-sky-500 to-sky-400 rounded-b-full w-64 shadow-md"></div>
 </div>
 </div>
 </div>
 </div>
