...
const MayBayModal = ({ isOpen, onClose, onSave, aircraft }) => {
 ...
 <div className="bg-sky-600 text-white p-6 rounded-t-xl sticky top-0">
 ...
 <button
 type="submit"
 className="px-6 py-3 bg-sky-500 text-white rounded-lg hover:bg-sky-600 font-semibold transition-all shadow-lg"
 >
