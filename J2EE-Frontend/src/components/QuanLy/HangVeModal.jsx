...
const COLOR_PRESETS = [
 ...
 mauHeader: ' from-[rgb(14,165,233)] to-[rgb(59,130,246)]',
 ...
 mauHeader: ' from-[rgb(16,185,129)] to-[rgb(20,184,166)]',
 ...
 mauHeader: ' from-[rgb(249,115,22)] to-[rgb(245,158,11)]',
 ...
 mauHeader: ' from-[rgb(147,51,234)] to-[rgb(79,70,229)]',
 ...
 mauHeader: ' from-[rgb(245,158,11)] to-[rgb(234,179,8)]',
 ...
 mauHeader: ' from-[rgb(244,63,94)] to-[rgb(236,72,153)]',
 ...
 * Lưu dạng: from-[rgb(r,g,b)] to-[rgb(r,g,b)]
 */
...
const HangVeModal = ({ isOpen, onClose, onSave, isEditMode, hangVe }) => {
 ...
 type="submit"
 disabled={submitting}
 className="w-full sm:w-auto px-4 md:px-6 py-2.5 md:py-3 bg-purple-500 text-white rounded-lg hover:bg-purple-600 font-semibold transition-all shadow-lg hover:shadow-xl disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
 >
 {submitting ? (
 <>
