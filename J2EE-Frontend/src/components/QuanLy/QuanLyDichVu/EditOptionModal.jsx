...
const EditOptionModal = ({ option, onClose, onSave, options }) => {
 ...
 useEffect(() => {
 if (option?.anh) {
 setImagePreview(getServiceOptionImageUrl(option.anh));
 }
 }, [option]);
 ...
 <button 
 type="submit" 
 className="px-6 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-600 font-semibold transition-all shadow-lg"
 >
 Lưu
 </button>
 </div>
