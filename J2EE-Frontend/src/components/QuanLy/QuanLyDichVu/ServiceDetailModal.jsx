...
const ServiceDetailModal = ({ service, options, onClose, onCreateOption, onEditOption, onDeleteOption }) => {
 ...
 <div className="bg-blue-600 text-white p-6 rounded-t-xl shrink-0">
 ...
 className="flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white font-semibold py-2 px-4 rounded-lg shadow-lg hover:shadow-xl transition-all"
 >
 <FaPlus size={14} />
 ...
 <img 
 src={option.anh ? getServiceOptionImageUrl(option.anh.split('/').pop()) : '/no-product.png'} 
