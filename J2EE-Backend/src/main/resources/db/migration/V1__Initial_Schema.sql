...
-- Description: Tạo tất cả các bảng và constraints cho hệ thống đặt vé máy bay
-- =================================================================
...
-- =================================================================
-- BẢNG RBAC (Role-Based Access Control)
-- =================================================================
...
CREATE INDEX `idx_token_rt` ON `refreshtoken` (`token`);
